...
<section class="relative flex items-center h-screen">
    ...
    <div x-data="parallaxBackground()" x-ref="bg" @scroll.window="handleScroll" class="absolute top-0 left-0 w-full h-full bg-fixed bg-no-repeat -z-1" style="background-image: url('{{ asset('images/beach.jpg')}}');background-position-x: center;"></div>
</section>
    ...
    function parallaxBackground() {
        return {
            ...
            handleScroll() {
                ...
                this.coords = yPos + "px";
                this.$refs.bg.style.backgroundPositionY = this.coords;
            }
        }
    }
</script>
