    ...
    <div class="max-w-3xl mx-auto">
        <article>
            ...
            <div class="pt-10 pb-8 prose lg:pt-14 max-w-none lg:prose-xl">
                ...
                <p>Ce jeu de frisbee atypique a vu le jour en 1994 en arcade, développé par Data East pour la Neo·Geo. Aujourd'hui, en plus du support original et de l'émulation, on peut s'y adonner sur PS4, PSVita et Nintendo Switch grâce à un portage réalisé par Dotemu.</p>
                ...
                <p>Des tournois en ligne sur GGPO puis FightCade, nous nous sommes retrouvés à plusieurs reprises lors de divers évènements et notamment le Stunfest et le HFS Summer durant lesquels nous avons pu organiser de magnifiques tournois dont le DiscMania, notre compétition annuelle de référence.</p>
